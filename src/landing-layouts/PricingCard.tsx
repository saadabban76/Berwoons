...
interface CardProps {
  title: "Standard" | "Most Popular" | "Custom";
  price: number | string;
}
...
const PricingCard = (props: CardProps) => {
  ...
  return (
    <div
      className={`relative w-full ${props.title === "Most Popular" && "h-[580px] w-[120%]"} min-h-[490px] max-w-sm p-4 border border-gray-200 rounded-lg 
    ...
    >
      ...
      <ul role="list" className="space-y-5 my-7">
        ...
        <li
          className={`${
            (props.title === "Most Popular" || props.title === "Custom") ? "flex space-x-3" : "hidden"
          }`}
        >
          <svg
            className="flex-shrink-0 w-4 h-4 text-blue-600 dark:text-blue-500"
          ...
          <span className="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">
            {(props.title === "Most Popular" || props.title === "Custom") &&
        ...
        <li
          className={`${
            props.title === "Standard" || props.title === "Most Popular"
              ? "flex"
              : "hidden"
          }
         space-x-3 line-through decoration-gray-500`}
